(function() {
  Ext.define("stable_mobile.view.horse.TempAdder", {
    ...
    requires: ['stable_mobile.controller.horse.TempAdderViewController', "Ext.form.FieldSet", "Ext.field.TextArea", "Ext.field.Text", "Ext.field.Number", "Ext.field.DatePicker"],
    config: {
      fullscreen: true,
      scrollable: false,
      padding: 20,
