(function() {
  Ext.define("stable_mobile.view.contact.Form", {
    ...
    requires: ['stable_mobile.controller.contact.FormViewController', "Ext.form.FieldSet", "Ext.field.Select", "Ext.field.TextArea", "Ext.field.Text", "Ext.field.DatePicker"],
    config: {
      fullscreen: true,
      scrollable: false,
      padding: 20,
